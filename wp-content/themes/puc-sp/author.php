	...
	<div class="container relative z-10 px-5">
		...
		<nav class="mb-4">
			<ol class="flex items-center gap-2 text-white/70 text-sm">
				...
				<li><span class="mx-2">/</span></li>
				<li class="text-white"><?php echo get_the_author(); ?></li>
			</ol>
		</nav>
		...
		<?php if (get_the_author_meta('description')) : ?>
			<p class="text-white/80 mt-4 max-w-3xl">
	...
	<div class="container px-5">
		...
		<?php else : ?>
			...
			<div class="max-w-4xl mx-auto text-center py-12">
				...
				<p class="text-gray-600">Este autor ainda não publicou nenhum conteúdo.</p>
			</div>
